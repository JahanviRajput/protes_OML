...
class OptiProtesNoisyComp(Opti):
    def __init__(self, name='noisyprotesnoisy', *args, **kwargs):
    ...
    def _optimize(self):
        protes_noise_comparison(self.f_batch, self.d, self.n[0], self.m_max, P=self.opts_P,
